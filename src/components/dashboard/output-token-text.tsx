...
const OutputTokenText = () => {
	...
	const { trendValue, trendLabel, showTrend } = useMemo(() => {
		...
		const current = data[0].currentOutputToken ?? 0;
		const prevFromApi = data[0].prevOutputToken ?? 0;
...
export default OutputTokenText;
